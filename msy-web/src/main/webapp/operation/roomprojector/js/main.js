...
//修改酒店
function conprojector(projectorId){
	console.log(""+projectorId);
	localStorage.setItem('projectorId', projectorId);
	var temp_url = getContextPath() + "/operation/roomprojector/addroompro.html";
    _Dialog('绑定房间号',temp_url); 
}