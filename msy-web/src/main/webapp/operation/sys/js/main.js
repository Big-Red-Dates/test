...
$(function() {
	...
	var menuList ='['
		...
		+ ',{"id": "roommgr-1","name": "房间查询","open": false,"orderNo": 0,"parent": false,"parentId": "roommgr","uri": "/operation/room/selroom.html"}'
		+ ',{"id": "conroom","name": "绑定房间号","open": false,"orderNo": 0,"parent": true,"parentId": "","uri": ""}'
		+ ',{"id": "conroom-1","name": "绑定房间号","open": false,"orderNo": 0,"parent": false,"parentId": "conroom","uri": "/operation/roomprojector/selroompro.html"}'
		+ ']';
...
// 修改密码
function modPwd(){
	var temp_url = getContextPath() + "/operation/sys/modifypwd.html";
